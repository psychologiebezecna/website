            ...
            <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-xl shadow-lg flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
              ...
              <div className="text-center md:text-left">
                ...
                <div className="mt-6 text-gray-600 space-y-4 text-justify">
                   <p>Vysokoškolské studium jednooborové psychologie jsem absolvovala na Pedagogické fakultě Univerzity Karlovy v Praze v roce 2018. Ještě během studia jsem 3 roky pracovala v neziskové organizaci Proxima Sociale, kde jsem v terapeutické dvojici lektorovala podpůrné skupiny pro dospívající (12–18 let), kteří měli zkušenost s příbuzenskou pěstounskou péčí anebo s {" "} <button type="button" className="relative font-normal decoration-dotted cursor-help" aria-describedby="ospod-tooltip">OSPOD</button>.<span id="ospod-tooltip" role="tooltip" className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-max max-w-xs px-2 py-1 bg-gray-700 text-white text-xs rounded-md shadow-lg opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity duration-300 pointer-events-none z-10">Orgán sociálně-právní ochrany dětí</span>.</p>
